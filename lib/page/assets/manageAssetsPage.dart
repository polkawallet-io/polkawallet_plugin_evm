...
class ManageAssetsPage extends StatefulWidget {
  ManageAssetsPage(this.plugin, {super.key});
...
class _ManageAssetsPageState extends State<ManageAssetsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    //       id: widget.plugin.networkState.tokenSymbol![0],
    //       symbol: widget.plugin.networkState.tokenSymbol![0],
    //       name: widget.plugin.networkState.tokenSymbol![0],
